...
//		GroupManager manager = getEngine().getGroupManager();
	 ...
	 * <code>null</code>, a synthetic {@link #guestSession(WikiEngine)}is
	 * returned.
	 * </p>
	 * <p>
	 * When a session is created, this method attaches a WikiEventListener to
	 * the GroupManager so that changes to groups are detected automatically.
	 * </p>
	 * 
	 * @param engine
	 *            the wiki engine

...
public class AttachmentServlet extends WebdavServlet {
    ...
    public void doPut(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            boolean created = executeUpload(context, data, path.getName(),
                    errorPage, wikipage, changeNote, req.getContentLength());
    ...
    protected String upload(HttpServletRequest req) throws RedirectException,
        ...
        try {
            ...
            msg = "Upload failed because the provider failed: "
                    + e.getMessage();
    ...
    protected boolean executeUpload(WikiContext context, InputStream data,
        ...
        if (mgrA.checkPermission(context.getWikiSession(), permission)) {
            if (user != null) {

...
public class DynamicAttachment extends Attachment {
     ...
     * 
     * @param engine
     *            The engine which owns this attachment
     * @param parentPage
     *            The page which owns this attachment
     * @param fileName
     *            The filename of the attachment
     * @param provider
     *            The provider which will be used to generate the attachment.
     */
    public DynamicAttachment(String parentPage,
            String fileName, DynamicAttachmentProvider provider) {

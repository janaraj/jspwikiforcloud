...
public class PageSorter implements Comparator, Serializable {
    private final static Log log = LogFactory.getLog(PageSorter.class);
     ...
     */
    public PageSorter(Properties props) {
    ...
    public int compare(Object o1, Object o2) {
        if (o1 instanceof String) {
            ...
            if (o2 instanceof WikiPage)
                return m_comparator.compare((String) o1,
                        ((WikiPage) o2).getName());
        } else if (o1 instanceof WikiPage) {
            if (o2 instanceof WikiPage)
                return m_comparator.compare(((WikiPage) o1).getName(),
                        ((WikiPage) o2).getName());
            if (o2 instanceof String)
                return m_comparator.compare(((WikiPage) o1).getName(),
                        (String) o2);
        ...
        throw new IllegalArgumentException(
                "Can only compare String or WikiPage");
    }

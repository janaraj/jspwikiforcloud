...
public final class GroupPermission extends Permission implements Serializable {
	/**
	 * Special target token that denotes all groups that a Subject's Principals
	 * are members of.
	 */
	private static final String MEMBER_TOKEN = "<groupmember>";
	 ...
	 */
	// public static final GroupPermission DELETE = new GroupPermission(
	// DELETE_ACTION );
	 ...
	 */
	// public static final GroupPermission EDIT = new GroupPermission(
	// EDIT_ACTION );
	 ...
	 */
	// public static final GroupPermission VIEW = new GroupPermission(
	// VIEW_ACTION );
	 ...
	 * @param actions
	 */
	protected GroupPermission(String actions) {
	...
	public final boolean equals(Object obj) {
		...
		return p.m_mask == m_mask && p.m_group.equals(m_group)
	...
	public final int hashCode() {
		...
		return m_mask
				+ ((13 * m_actionString.hashCode()) * 23 * wiki.hashCode());
	}
	 ...
	 * </p>
	 * <ol>
	 * <li>The other GroupPermission&#8217;s wiki is equal to, or a subset of,
	 * that of this permission. This permission&#8217;s wiki is considered a
	 * superset of the other if it contains a matching prefix plus a wildcard,
	 * or a wildcard followed by a matching suffix.</li>
	 * <li>The other GroupPermission&#8217;s target is equal to, or a subset of,
	 * the target specified by this permission. This permission&#8217;s target
	 * is considered a superset of the other if it contains a matching prefix
	 * plus a wildcard, or a wildcard followed by a matching suffix.</li>
	 * <li>All of other GroupPermission&#8217;s actions are equal to, or a
	 * subset of, those of this permission</li>
	 * </ol>
	 * 
	 * @param permission
	...
	public final String toString() {
		...
		return "(\"" + this.getClass().getName() + "\",\"" + wiki
				+ WIKI_SEPARATOR + m_group + "\",\"" + getActions() + "\")";
	}
	...
	/**
	 * Protected method that creates a binary mask based on the actions
	 * specified. This is used by {@link #implies(Permission)}.
	 * 
	 * @param actions
	 ...
	 * token <code>&lt;groupmember&gt;</code> <em>and</em> the current
	 ...
	 * </p>
	 * <p>
	 * We make this determination by obtaining the current {@link Thread}
	 * &#8217;s {@link java.security.AccessControlContext} and requesting the
	 * {@link javax.security.auth.SubjectDomainCombiner}. If the combiner is not
	 * <code>null</code>, then we know that the access check was requested using
	 * a {@link javax.security.auth.Subject}; that is, that an upstream caller
	 * caused a Subject to be associated with the Thread&#8217;s
	 ...
	 * simple: just iterate through the Subject&#8217;s Principal set and look
	 * for all Principals of type {@link org.apache.wiki.auth.GroupPrincipal}.
	 * If the name of any Principal matches the value of the implied
	 * Permission&#8217;s {@link GroupPermission#getGroup()} value, then the
	 * Subject is a member of this group -- and therefore this
	 * <code>impliesMember</code> call returns <code>true</code>.
	 * </p>
	 * <p>
	 * This may sound complicated, but it really isn&#8217;t. Consider the
	 * following examples:
	 * </p>
	 * <table border="1">
	 * <thead>
	 ...
	 * <td><code>WikiPrincipal ("Biff"),<br/>GroupPrincipal ("TestGroup")</code>
	 * </td>
	 ...
	 * Permission functions exactly the way it should during normal operations.
	 * </p>
	 * 
	 * @param permission
	 *            the implied permission
	 * @return <code>true</code> if the calling Thread&#8217;s Subject contains
	 *         a GroupPrincipal matching the implied GroupPermission&#8217;s
	...
	protected final boolean impliesMember(Permission permission) {
		...
		// WikiSubject subject = mm_wiki.getSubject();
		WikiSubject subject = BeanHolder.getSubject();
		Set<GroupPrincipal> principals = subject
				.getPrincipals(GroupPrincipal.class);

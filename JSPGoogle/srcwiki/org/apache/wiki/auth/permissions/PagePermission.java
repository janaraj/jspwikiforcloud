 ...
 * ,&nbsp; <code>upload</code>,&nbsp;<code>modify</code>&nbsp;(edit text and
 * upload attachments),&nbsp;<code>delete</code>&nbsp; and&nbsp;
 * <code>rename</code>.
 * </p>
 * <p>
 ...
 * </p>
 * <ul>
 * <li><code>delete</code>&nbsp;and&nbsp;<code>rename</code>&nbsp;imply&nbsp;
 * <code>edit</code></li>
 * <li><code>modify</code>&nbsp;implies&nbsp;<code>edit</code>&nbsp;and&nbsp;
 * <code>upload</code></li>
 * <li><code>edit</code>&nbsp;implies&nbsp;<code>comment</code>&nbsp;and&nbsp;
 * <code>view</code></li>
 * <li><code>comment</code>&nbsp;and&nbsp;<code>upload</code>&nbsp;imply&nbsp;
 * <code>view</code></li>
...
public final class PagePermission extends Permission implements Serializable {
    ...
    public static final PagePermission COMMENT = new PagePermission(
            COMMENT_ACTION);

    /** A static instance of the delete permission. */
    public static final PagePermission DELETE = new PagePermission(
            DELETE_ACTION);
    ...
    public static final PagePermission RENAME = new PagePermission(
            RENAME_ACTION);

    /** A static instance of the modify permission. */
    public static final PagePermission MODIFY = new PagePermission(
            MODIFY_ACTION);

    /** A static instance of the upload permission. */
    public static final PagePermission UPLOAD = new PagePermission(
            UPLOAD_ACTION);
    ...
    public PagePermission(String page, String actions) {
        ...
        // Parse actions
        String[] pageActions = StringUtils.split(actions.toLowerCase(),
                ACTION_SEPARATOR);
     ...
     * "modify", "upload" or "delete". The actions will always be sorted in
    ...
    public final String toString() {
        ...
        return "(\"" + this.getClass().getName() + "\",\"" + wiki
                + WIKI_SEPARATOR + m_page + "\",\"" + getActions() + "\")";
    }

 ...
 * </p>
 * <p>
 * The target is a given wiki. The syntax for the target is the wiki name.
 * "All wikis" can be specified using a wildcard (*). Page collections may also
 * be specified using a wildcard. For pages, the wildcard may be a prefix,
 * suffix, or all by itself.
 * <p>
...
public final class WikiPermission extends Permission implements Serializable {
	...
	public static final WikiPermission CREATE_GROUPS = new WikiPermission(
			WILDCARD, CREATE_GROUPS_ACTION);

	/** A static instance of the createPages permission. */
	public static final WikiPermission CREATE_PAGES = new WikiPermission(
	...
	public static final WikiPermission EDIT_PREFERENCES = new WikiPermission(
			WILDCARD, EDIT_PREFERENCES_ACTION);

	/** A static instance of the editProfile permission. */
	public static final WikiPermission EDIT_PROFILE = new WikiPermission(
			WILDCARD, EDIT_PROFILE_ACTION);
	...
	public final boolean equals(Object obj) {
		...
		return p.m_mask == m_mask && p.m_wiki != null
	...
	public final int hashCode() {
		return m_mask
				+ ((13 * m_actionString.hashCode()) * 23 * m_wiki.hashCode());
	}
	 ...
	 * 
	 * @param permission
	 *            the permission which may (or may not) be implied by this
	 *            instance

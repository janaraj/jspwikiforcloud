 ...
 * the diff.
 */
public class ExternalDiffProvider extends AbstractWikiProvider implements DiffProvider {
	private static final Log log = LogFactory
			.getLog(ExternalDiffProvider.class);
	...
	// FIXME This could/should be a property for this provider, there is not
	// guarentee that
	...
	/**
	 * @see org.apache.wiki.WikiProvider#getProviderInfo() {@inheritDoc}
	 */
	...
	public void initialize(WikiEngine engine, Properties properties)
		...
		if ((null == m_diffCommand) || (m_diffCommand.trim().equals(""))) {
			throw new NoRequiredPropertyException(
					"ExternalDiffProvider missing required property",
					PROP_DIFFCOMMAND);
		}
	...
	/**
	 * Makes the diff by calling "diff" program. {@inheritDoc}
	 */
	public String makeDiffHtml(WikiContext ctx, String p1, String p2) {
		...
		try {
			...
			String cmd = TextUtil.replaceString(m_diffCommand, "%s1",
					f1.getPath());

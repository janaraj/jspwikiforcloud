...
public class TabbedSectionTag extends BodyTagSupport
{
    ...
    public void setDefaultTab(String anDefaultTabId)
    {
        ...
        log.debug("Set default tag = " + m_defaultTabId );
    }
    ...
    {
    	log.debug("TabbedSectionTag - doAfterBody");
        if( isStateFindDefaultTab() )
        {
        	log.debug("TabbedSectionTag - isStateFindDefault");
        ...
        {
        	log.debug("TabbedSectionTag - isStateGenerateTabMenu");
            if( bodyContent != null )
            {
            	log.debug("TabbedSectionTag - isStateGenerateTabMenu NOT NULL");
        ...
        {
        	log.debug("TabbedSectionTag - isStateGenerateTabBody");
            if( bodyContent != null )
            {
            	log.debug("TabbedSectionTag - isStateGenerateTab NOT NULL");

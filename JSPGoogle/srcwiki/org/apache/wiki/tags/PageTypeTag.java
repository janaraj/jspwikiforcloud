...
public class PageTypeTag extends WikiTagBase {
	...
	public void setType(String arg) {
		...
		log.debug("SetType=" + m_type);
	}

	public final int doWikiStartTag() throws IOException {
		WikiPage page = m_wikiContext.getPage();
		log.debug("doWikiStartTag=" + page.getName());

		if (page != null) {
			log.debug("doWikiStartTag PAGE != null");			
			if (m_type.equals("attachment") && page instanceof Attachment) {
				log.debug("doWikiStartTag Eval_Body_Include");							
			...
			if (m_type.equals("weblogentry") && !(page instanceof Attachment)

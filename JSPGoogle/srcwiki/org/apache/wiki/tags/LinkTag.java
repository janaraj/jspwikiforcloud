 ...
 * <p>
 * If parameter <i>jsp</i> is defined, constructs a URL pointing to the
 * specified JSP page, under the baseURL known by the WikiEngine. Any ParamTag
...
public class LinkTag extends WikiLinkTag implements ParamHandler, BodyTag {
    ...
    private String m_urlParam = null;
    ...
    public void setUrlParam(String param) {
        this.m_urlParam = param;
    }

    public String getUrlParam() {
        return this.m_urlParam;
    }
    ...
    private String figureOutURL() throws ProviderException {
        ...
        if (m_templatefile != null) {
            ...
            url = engine.getURL(WikiContext.NONE, "templates/" + template + "/"
                    + m_templatefile, params, false);
        } else if (m_jsp != null) {
            String params = addParamsForRecipient(null, m_containedParams);
            ...
            if (JSPWikiMarkupParser.isExternalLink(m_ref)) {
                ...
                String parms = (m_version != null) ? "version=" + getVersion()
                        : null;
                ...
                if (p instanceof Attachment) {
                    ...
                    if ((matchedLink = engine.getFinalPageName(reallink)) != null) {
                        sectref = "section-" + engine.encodeName(matchedLink)
                                + "-" + namedSection;
                    ...
                    url = makeBasicURL(m_context, matchedLink, parms,
                            m_absolute) + sectref;
                } else {
    ...
    private String makeBasicURL(String context, String page, String parms,
        ...
        if (context.equals(WikiContext.DIFF)) {
            ...
            if (DiffLinkTag.VER_LATEST.equals(getVersion())) {
                WikiPage latest = engine.getPage(page,
    ...
    public int doEndTag() {
        try {
            if (!m_overrideAbsolute) {
                ...
                // specified somewhere.
                WikiEngine engine = m_wikiContext.getEngine();
                m_absolute = "absolute".equals(engine.getWikiProperties()
                        .getProperty(WikiEngine.PROP_REFSTYLE));
            }

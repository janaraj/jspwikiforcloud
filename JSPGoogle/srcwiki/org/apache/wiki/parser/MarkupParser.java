...
public abstract class MarkupParser {
    ...
    /**
     * Lists all punctuation characters allowed in WikiMarkup. These will not be
     * cleaned away. This is for compatibility for older versions of JSPWiki.
     */
    ...
    /**
     * Constructs a MarkupParser. The subclass must call this constructor to set
     * up the necessary bits and pieces.
     * 
     * @param context
     *            The WikiContext.
     * @param in
    ...
    /**
     * Adds a HeadingListener to the parser chain. It will be called whenever a
     * parsed header is found.
     * 
     * @param listener
     *            The listener to add.
     */
    ...
    /**
     * Return the current position in the reader stream. The value will be -1
     * prior to reading.
     * 
    ...
    /**
     * Returns the next token in the stream. This is the most called method in
     * the entire parser, so it needs to be lean and mean.
     * 
    ...
    /**
     * Cleans away extra legacy characters. This method functions exactly like
     * pre-2.6 cleanLink()
     * <P>

...
<%
    ...
    String alert = LocaleSupport.getLocalizedMessage(pageContext,
            "downloadwiki.upload.mustenterfilename");
%>
<div id="uploadwikitab">
	...
	<form action="<%=uploadWikiAction%>" class="wikiform" id="uploadform"
		...
		<table>
			<tr>
				<td colspan="2"><div class="formhelp">
						<fmt:message key="downloadwiki.upload.info" />
					</div></td>
			</tr>
			<tr>
